...
class ShopCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            $available_at = implode(', ', $row->stores->pluck('title')->toarray());
            $dataTr[] = [
                'check_row' => '<input type="checkbox" class="grid-row-checkbox" data-id="' . $row['id'] . '">',
                'id' => $row['id'],
                'image' => cdn_image_render($row->getThumb(), '50', '50'),
                'name' => $row['name'],
    ...
    public function create()
    {
        $data = [
            ...
            'stores' => Store::getStores(), //$brand_id=Admin::brand_id()
    ...
    public function postCreate()
    {
        ...
        $validator = Validator::make($data, [
            ...
            'store.required' => trans('validation.required', ['attribute' => trans('category.store')]),
        ...
        $image = cdn_image_upload_from_storage($data['image'], 'banners');
    ...
    public function postEdit($id)
    {
        ...
        $image = cdn_image_upload_from_storage($data['image'], 'categories');
