...
class ShopExtraProduct extends Model
{
    ...
    {
        return $this->belongsToMany(ShopProduct::class, 'shop_product_shop_extraproduct', 'extraproduct_id', 'product_id');
    }
 ...
 */
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope(new ExtraScope);
