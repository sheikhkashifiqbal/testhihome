...
class ShopOrder extends Model
{
    ...
    public function branch()
    {
        ...
        ->select('id','phone','email','lat','long','logo','address');
    }
    public function store()
    {

        return $this->belongsTo(AdminStore::class, 'store_id', 'id')->with('description')
        ->select('id','phone','email','lat','long','logo','address', 'legal_business_email', 'legal_business_phone');
    }
