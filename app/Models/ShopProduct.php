 ...
 */
    ...
    public function builds()
    {
     ...
     public function seller() {
        ...
        return $this->belongsTo(AdminStoreDescription::class, 'store_id', 'config_id')->where('lang', $lang);
    }
 ...
 */
    ...
    public function scopeWithRelations($query, $active)
    {
      return $query->where('shop_product.status', $active)
    ...
    {
      return $query->whereRaw('(id = ' . (int) $keyword . ' OR shop_product_description.name like "%' . $keyword . '%" )');
    }

    public function scopeWithSort($query, $sort_order)
    {
    ...
    public function scopeWithCategoryFilter($query, $category_id)
    {
    ...
    public function scopeWithStoreFilter($query, $store_id)
    {
      return $query->whereHas('seller',
                              function ($q) use ($store_id) {
                                  $q->where('config_id', $store_id);
                              });
    }
