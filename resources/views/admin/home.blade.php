...
<div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">{{ trans('admin.total_seller') }}</span>
              <span class="info-box-number">{{ number_format($sellers->count()) }}</span>
              <a href="{{ route('admin_customer.index',array('user'=>'seller')) }}" class="small-box-footer">
                  {{ trans('admin.more') }}&nbsp;
                  <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ number_format($customers->count()) }}</span>
              <a href="{{ route('admin_customer.index',array('type'=>1)) }}" class="small-box-footer">
                  {{ trans('admin.more') }}&nbsp;
                  <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
...
{{-- Top customer --}}
@php
  $topCustomer = $customers->orderBy('id','desc')->limit(10)->get();
@endphp
  <div class="col-md-6">
    <div class="box box-primary">
      <div class="box-header with-border">
