...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <!-- form start -->
            <form action="{{ route('admin_offers.edit',['id'=>$offer->id]) }}" method="post" accept-charset="UTF-8"
                  ...
                  <div class="box-body">
                      <div class="fields-group">
                          ...
                          <div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-8">
                                  <div class="input-group">
                                      <input type="text" id="code" name="code" value="{{ old('code', $offer->code) }}" class="form-control" placeholder="" />
                                  </div>
                                  @if ($errors->has('code'))
                                  <span class="help-block">
                          ...
                          <div class="form-group {{ $errors->has('value') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-8">
                                  <div class="input-group">
                                      <input type="number" id="value" name="value" value="{{ old('value', $offer->value) }}" class="form-control" placeholder="" />
                                  </div>
                                  @if ($errors->has('value'))
                                  <span class="help-block">
                          ...
                          <div class="form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-8">
                                  <div class="input-group">
                                      <input type="text" id="start_date" name="start_date" value="{{ old('start_date', \Carbon\Carbon::parse($offer->start_date)->format('d-m-Y'))}}" class="form-control date_time" placeholder="" />
                                  </div>
                          ...
                          <div class="form-group {{ $errors->has('end_date') ? ' has-error' : '' }}">
                              ...
                              <div class="col-sm-8">
                                  <div class="input-group">
                                      <input type="text" id="end_date" name="end_date" value="{{ old('end_date', \Carbon\Carbon::parse($offer->end_date)->format('d-m-Y')) }}" class="form-control date_time" placeholder="" />
                                  </div>
                          ...
                          <div class="form-group ">
                              ...
                              <div class="col-sm-8">
                                @if (old())
                                  <input type="checkbox" data-toggle="switch"  name="status" {{ old('status',$offer['status'])?'checked':''}} data-on-color="success" data-off-color="danger">
                                @else
                                  <input type="checkbox" name="status" data-on-text="ON" data-off-text="OFF"  {{ ($offer['status'])?'checked':''}} data-on-color="success" data-off-color="danger">
                                @endif
...
<script type="text/javascript">
    ...
    $("[name='top'],[name='status'],[name='out_of_stock'],[name='gluten_free']").bootstrapSwitch();
