        ...
        <div class="box">
            ...
            <div class="panel panel-default">
                <div class="panel-title">
                    <p class="text-center">{{trans('store_info.info')}}</p>
                </div>
                 <div class="panel-body">

                <h5>{{trans('store.name').' : '.@$product->seller->title}}</h5>


                <h5>{{trans('store.city').' : '.@$product->seller->city}}</h5>

                <h5>{{trans('store.address').' : '.@$product->seller->address}}</h5>

                <h5>{{trans('store_info.legal_business_email').' : '.@$product->stores->legal_business_email}}</h5>

                <h5>{{trans('store_info.contact_us_email').' : '.@$product->stores->contact_us_email}}</h5>
                ...
                <div class="box-body">
                    <div class="fields-group">
                        ...
                        <div class="form-group   {{ $errors->has('descriptions.'.$code.'.name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input dir="{{($code == 'ar') ? 'rtl' : ''}}" type="text" id="{{ $code }}__name" name="descriptions[{{ $code }}][name]"
                        ...
                        <div
                            ...
                            <div class="col-sm-8">
                                <textarea  dir="{{($code == 'ar') ? 'rtl' : ''}}" id="{{ $code }}__description"
                        ...
                        <div
                            ...
                            <div class="col-sm-8">{{-- editor --}}
                                <textarea id="{{ $code }}__content" class="form-control input-sm"
                                          name="descriptions[{{ $code }}][content]">{!! old('descriptions.'.$code.'.content',($descriptions[$code]['content']??'')) !!}</textarea>
                        ...
                        <?php //@if (sc_config('product_ingredients'))    ?>
                        <div
                            class="form-group  {{ $errors->has('descriptions.'.$code.'.ingredients') ? ' has-error' : '' }}">
                            <label for="{{ $code }}__ingredients"
                                   class="col-sm-2  control-label">{{ trans('product.ingredients') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <textarea dir="{{($code == 'ar') ? 'rtl' : ''}}" id="{{ $code }}__description"
                                          name="descriptions[{{ $code }}][ingredients]"
                                          class="form-control input-sm {{ $code.'__ingredients' }}" placeholder="" />{!! old('descriptions.'.$code.'.ingredients',($descriptions[$code]['ingredients']??'')) !!}</textarea>
                                @if ($errors->has('descriptions.'.$code.'.ingredients'))
                                <span class="help-block">
                                    <i class="fa fa-info-circle"></i>
                                    {{ $errors->first('descriptions.'.$code.'.ingredients') }}
                                </span>
                                @else
                                <span class="help-block">
                                    <i class="fa fa-info-circle"></i> {{ trans('admin.max_c',['max'=>300]) }}
                        ...
                        <?php //@endif ?>
                        @if (sc_config('product_allergies'))
                        <div
                            class="form-group  {{ $errors->has('descriptions.'.$code.'.allergies') ? ' has-error' : '' }}">
                            <label for="{{ $code }}__allergies"
                                   class="col-sm-2  control-label">{{ trans('product.allergies') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <textarea id="{{ $code }}__description"
                                          name="descriptions[{{ $code }}][allergies]"
                                          class="form-control input-sm {{ $code.'__allergies' }}" placeholder="" />{!! old('descriptions.'.$code.'.allergies',($descriptions[$code]['allergies']??'')) !!}</textarea>
                                @if ($errors->has('descriptions.'.$code.'.allergies'))
                                <span class="help-block">
                                    <i class="fa fa-info-circle"></i>
                                    {{ $errors->first('descriptions.'.$code.'.allergies') }}
                                </span>
                                @else
                                <span class="help-block">
                                    <i class="fa fa-info-circle"></i> {{ trans('admin.max_c',['max'=>300]) }}
                        ...
                        @endif
                        @if (sc_config('product_gluten_free'))
                        {{-- Gluten Free --}}
                        <div class="form-group  ">
                            <label for="gluten_free" class="col-sm-2  control-label">{{ trans('product.gluten_free') }}</label>
                            <div class="col-sm-8">
                                @if (old())
                                <input type="checkbox" name="gluten_free" {{ old('gluten_free',$product['gluten_free'])?'checked':''}}>
                                       @else
                                       <input type="checkbox" name="gluten_free" {{($product['gluten_free'])?'checked':''}}>
                                @endif
                        ...
                        <div class="form-group  kind kind0 kind1  {{ $errors->has('weight') ? ' has-error' : '' }}">
                            <label for="weight" class="col-sm-2  control-label">{{ trans('product.weight') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="number" style="width: 100px;" id="weight" name="weight"
                                           value="{!! old('weight',$product->weight) !!}" class="form-control input-sm price"
                                           placeholder="" />
                                </div>
                    ...
                    <div class="form-group   {{ $errors->has('image') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div id="preview_image" class="img_holder">
                                ...
                                {!! cdn_image_render($product->image) !!}
                                @endif
                            </div>
                            @php
                    ...
                    {{-- prepration_time --}}
                    <div class="form-group   {{ $errors->has('sort') ? ' has-error' : '' }}">
                        <label for="prepration_time" class="col-sm-2  control-label">{{ trans('product.prepration_time') }}</label>
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input type="text" style="width: 100px;" id="prepration_time" name="prepration_time"
                                       value="{!! old('sort',$product['prepration_time']) !!}" class="form-control sort"
                                       placeholder="" />
                            </div>
                            @if ($errors->has('prepration_time'))
                            <span class="help-block">
                                <i class="fa fa-info-circle"></i> {{ $errors->first('prepration_time') }}
                            </span>
                            @endif
                        </div>
                    </div>
                    ...
                    {{-- serving count --}}
                    <div class="form-group   {{ $errors->has('sort') ? ' has-error' : '' }}">
                        <label for="serve_count" class="col-sm-2  control-label">{{ trans('product.serving_for') }}</label>
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input type="text" style="width: 100px;" id="serve_count" name="serve_count"
                                       value="{!! old('sort',$product['serve_count']) !!}" class="form-control sort"
                                       placeholder="" />
                            </div>
                            @if ($errors->has('serve_count'))
                            <span class="help-block">
                                <i class="fa fa-info-circle"></i> {{ $errors->first('serve_count') }}
                            </span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group  ">
                        ...
                        <div class="col-sm-8">
                            @if (old())
                              <input type="checkbox" data-toggle="switch"  name="status" {{ old('status',$product['status'])?'checked':''}} data-on-color="success" data-off-color="danger">
                            @else
                              <input type="checkbox" name="status" data-on-text="ON" data-off-text="OFF"  {{ ($product['status'])?'checked':''}} data-on-color="success" data-off-color="danger">
                            @endif
                    ...
                    {{-- Out of stock --}}
                    <div class="form-group  ">
                        <label for="out_of_stock" class="col-sm-2  control-label">{{ trans('product.out_of_stock') }}</label>
                        <div class="col-sm-8">
                            @if (old())
                              <input type="checkbox" data-toggle="switch" name="out_of_stock" {{ old('out_of_stock',$product['out_of_stock'])?'checked':''}} data-on-color="danger" data-off-color="success">
                            @else
                              <input type="checkbox" data-toggle="switch" name="out_of_stock" data-on-text="Yes" data-off-text="No"  {{ ($product['out_of_stock'])?'checked':''}} data-on-color="danger" data-off-color="success">
                            @endif
...
$("[name='top'],[name='status'],[name='out_of_stock'],[name='gluten_free']").bootstrapSwitch();</script>
