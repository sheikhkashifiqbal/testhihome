            ...
            <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"
                ...
                <div class="box-body">
                    <div class="fields-group">
                        ...
                        {{-- select store --}}
                        <div class="form-group  kind kind0 kind1 {{ $errors->has('store') ? ' has-error' : '' }}">
                            <hr>
                            @php
                            
                            if(Route::currentRouteName()=='admin_category.edit') :
                                // edit
                                $store = old('store',$category->stores->pluck('id')->toArray());
                            ...
                            <label for="store"
                                class="col-sm-2  control-label asterisk">Associated stores:</label>
                            <div class="col-sm-8">
                                <select class="form-control input-sm category select2" multiple="multiple"
                                    data-placeholder="Choose at least one store" style="width: 100%;"
                                    name="store[]">
                                    <option value=""></option>
