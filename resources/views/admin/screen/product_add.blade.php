...
@endif
                        <div class="form-group   kind kind0  {{ $errors->has('descriptions.'.$code.'.content') ? ' has-error' : '' }}">
                            <label for="{{ $code }}__content"
                                class="col-sm-2  control-label">{{ trans('product.content') }} <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
...
@if (sc_config('product_ingredients'))                        
                        <div
                            ...
                            <div class="col-sm-8">
                                    <textarea id="{{ $code }}__description"
                                        ...
                                        class="form-control input-sm {{ $code.'__ingredients' }}" placeholder="" />{{ old('descriptions.'.$code.'.ingredients') }}</textarea>
                        ...
                        <div
                            ...
                            <div class="col-sm-8">
                                    <textarea id="{{ $code }}__description"
                                        ...
                                        class="form-control input-sm {{ $code.'__allergies' }}" placeholder="" />{{ old('descriptions.'.$code.'.allergies') }}</textarea>
...
@if (sc_config('product_gluten_free'))  
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-8">
                                @if (old())
                                <input type="checkbox" name="gluten_free" {{ ((old('gluten_free') ==='on')?'checked':'')}}>
                                @else
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" style="width: 100px;" id="weight" name="weight"
                                        value="{!! old('weight')??0 !!}" class="form-control input-sm price"
                                        placeholder="" />
                                </div>
                        ...
                        <div class="form-group  kind kind0 kind1 {{ $errors->has('category') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control input-sm category select2" multiple="multiple"
                                    ...
                                    @foreach ($stores_with_categories as $store) 
                                    
                                       
                                        <optgroup label="{{$store->descriptions->keyBy('lang')[sc_get_locale()]->title}}">
                                            @foreach ($store->categories as $cat)
                                                <option value="{{$cat->id}}" {{ (count($listCate) && in_array($cat->id, $listCate))?'selected':'' }}>
                                                    {{$cat->descriptions->keyBy('lang')[sc_get_locale()]['name'] }}
                                                </option>
                                            @endforeach
                                        </optgroup>
...
<script type="text/javascript">
    $("[name='top'],[name='status'],[name='gluten_free']").bootstrapSwitch();
</script>
