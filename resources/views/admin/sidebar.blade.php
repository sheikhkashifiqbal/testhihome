@php 
//get the user menu
$all_user_menu=session::get('roles_meny_array');
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @endphp
            <li class=""><a href="{{ route('admin.home') }}"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
            {{-- Level 0 --}}
            @foreach ($menus[0] as $level0)
            @if(in_array($level0->id, $all_user_menu))
            <?php
            ?>
            <li class="header">
            ...
            @if(in_array($level1->id, $all_user_menu))
            @if($level1->uri)
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    @if(in_array($level2->id, $all_user_menu))
                    @if($level2->uri)
